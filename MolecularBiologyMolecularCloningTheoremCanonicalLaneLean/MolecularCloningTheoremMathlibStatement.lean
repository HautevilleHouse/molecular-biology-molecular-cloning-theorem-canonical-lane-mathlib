...
import HautevilleHouse.MolecularBiologyMolecularCloningTheoremCanonicalLaneLean.MolecularCloningTheoremMathlibObjects
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "molecular-cloning-canonical-lane",
  theoremObject := "Molecular Cloning Theorem",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedMolecularCloningTheoremClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_molecular_cloning_theorem_endgame A
